...
$( "#createAcoD" ).click(function() {
  // $(".login-form").css("display", 'display');
  // $(".form .register-form").css("display", 'block');
  //  $(".form .login-form").css("display", 'none');

$(".form .register-form" ).fadeIn( "200");
$(".form .login-form" ).fadeOut( "100" );

  //alert("vales verga obiken");
});

$( "#signinD" ).click(function() {

  $(".form .login-form" ).fadeIn( "200" );
  $(".form .register-form" ).fadeOut( "100" );
